...
const TaskTutorialOne = (props) => {
    ...
    const warning = <div><p style={{color:'red'}}>Please do not refresh the page while taking the study.
     You would be unable to complete the experiment.</p>
      <p style={{color:'red'}}>We also ask that you do not use COPY/PASTE when completing the study. Unfortunately if you use copy/paste we will not be able to use your data.</p>
     <p>Thank you for your understanding!</p></div>
    

    const text = <div>
        <p>Thank you for taking part in our study!</p>
        <p>You will read a simple story, and tell us what you think about what happened. Please make sure to pay attention to what happens in the story!</p>
